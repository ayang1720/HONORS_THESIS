...
cs=axs.scatter(lonCell,latCell,c=smois[:,3],cmap='jet',s=50,marker='*',transform=ccrs.PlateCarree())
cbar=plt.colorbar(cs,orientation='horizontal')
cbar.set_label('soil moisture layer 4',fontsize=24)

#tricontourf plots (i have never used this module before, so i got help from chatGPT)

plt.savefig('plot_scatter_soil4.png')
plt.close()